/**
 * IFFingerprint Demo Application - Standalone Version
 * JavaScript untuk halaman demo (tanpa module imports)
 */
 ...
 */
function init() {
  // Check if IFFingerprint is available
  if (typeof IFFingerprint === "undefined") {
    console.error("IFFingerprint library not loaded!");
    elements.fingerprintDisplay.textContent = "Error: Library not loaded";
    return;
  }
